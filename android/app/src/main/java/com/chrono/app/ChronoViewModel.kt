...
class ChronoViewModel(app: Application) : AndroidViewModel(app) {
    ...
    private fun shotJson(r: TestResult): JSONObject = JSONObject()
        ...
        .put("velocityMps", if (r.hasReportableVelocity) r.metersPerSecond else JSONObject.NULL)
        .put("velocityFps", if (r.hasReportableVelocity) r.feetPerSecond else JSONObject.NULL)
